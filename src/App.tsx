  ...
  return (
    ...
    <div className="app">
      ...
      <div className="space-switch">
        ...
        <NotificationBell profile={profile} refreshTrigger={notifTick} onNavigate={(date, taskSpace) => {
          setSpace(taskSpace === "work" ? "work" : "life");
          setTab("date");
      ...
      {tab === "date" && (
        <div className="view">
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
            ...
            <h1 style={{ margin: 0 }}>{relativeDayLabel(selectedDate)}</h1>
            <div className="why" onClick={() => setSelectedDate(addDaysStr(selectedDate, 1))}>{relativeDayLabel(addDaysStr(selectedDate, 1))} →</div>
          ...
          {selectedDate === todayValue && (
            <>
              ...
              {(space === "life" || space === "general") && <Countdown entities={entities} />}
            </>
          )}
