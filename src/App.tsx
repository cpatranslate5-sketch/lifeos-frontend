...
// Filtering only — DateList handles sorting (by time, with drag-to-reorder overrides).
    ...
    <div className="app">
      ...
      {tab === "yesterday" && (
        <div className="view">
          ...
          <QuickTaskAdd date={yesterdayValue} onAdded={refresh} />
      ...
      {tab === "today" && (
        <div className="view">
          ...
          <QuickTaskAdd date={todayValue} onAdded={refresh} />
      ...
      {tab === "tomorrow" && (
        <div className="view">
          ...
          <QuickTaskAdd date={tomorrowValue} onAdded={refresh} />
      ...
      {tab === "date" && (
        <div className="view">
          ...
          <QuickTaskAdd date={selectedDate} onAdded={refresh} />
