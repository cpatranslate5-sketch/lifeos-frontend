    ...
    <div className="app">
      ...
      {tab === "date" && (
        <div className="view">
          ...
          {showDatePicker && (
            <input type="date" autoFocus value={selectedDate}
              onChange={e => { setSelectedDate(e.target.value); setShowDatePicker(false); }}
              style={{ background: "var(--card)", border: "1px solid var(--line)", borderRadius: 8, color: "var(--text)", padding: "5px 8px", fontSize: "0.8rem", marginBottom: 16 }} />
          )}
