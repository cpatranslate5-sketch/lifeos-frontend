...
export default function EntityCard({ e, onChanged, selectedDate, showNextStep, profile, onFilterByCriterion }: Props) {
  ...
  if (e.type === "anniversary") {
    return (
      <div className="card card-with-cover" style={cardBgStyle} tabIndex={0} onPaste={handleCardPaste}
        ...
        <div className={`card-body ${e.attributes?.background_path ? "card-text-panel" : ""}`}>
