  ...
  return (
    <div className="card">
      <div className="card-top">
        ...
        <input className="card-title-input" style={isDoneToday ? { textDecoration: "line-through", textDecorationColor: "var(--event)", textDecorationThickness: 2, color: "var(--muted)" } : {}}
          defaultValue={e.name}
