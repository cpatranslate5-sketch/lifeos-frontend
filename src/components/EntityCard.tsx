...
export type FilterKind = "genre" | "geo" | "author" | "actor" | "year";
...
export default function EntityCard({ e, onChanged, selectedDate, showNextStep, profile, onFilterByCriterion, layout }: Props) {
  ...
  const CARD_COLORS = [
    { name: "Красный", value: "#F5C6C6" },
    { name: "Оранжевый", value: "#F5DCC0" },
    { name: "Жёлтый", value: "#F5EFC0" },
    { name: "Зелёный", value: "#C9E8C9" },
    { name: "Голубой", value: "#C6E0F5" },
    { name: "Синий", value: "#C6CFF5" },
    { name: "Фиолетовый", value: "#DCC6F5" },
  ];
