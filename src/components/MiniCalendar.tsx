...
export default function MiniCalendar({ minDate, onSelect }: { minDate: string; onSelect: (date: string) => void }) {
    ...
    <div className="mini-calendar" onClick={(ev) => ev.stopPropagation()}>
      ...
      <div className="mini-calendar-grid">
        {cells.map((d, i) => {
          ...
          return (
            <span key={i} className={`mini-calendar-day ${disabled ? "disabled" : ""}`}
