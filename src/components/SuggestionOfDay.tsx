...
import { Entity, entityCoverUrl } from "../api";
  ...
  return (
    <div className="suggestion-of-day">
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
        {pick.attributes?.cover_path && !liteMode && (
          <img src={entityCoverUrl(pick.attributes.cover_path)} alt="" className="suggestion-cover" />
        )}
