...
export default function MediaTab({ title, placeholder, type, items, onChanged, profile }: Props) {
  ...
  return (
    <div className="view">
      ...
      <div className="edit-link" style={{ marginBottom: 10, display: "inline-block" }} onClick={() => setShowDetails(!showDetails)}>
        {showDetails ? "скрыть подробности" : "+ указать жанр/автора/гео сразу"}
      </div>
